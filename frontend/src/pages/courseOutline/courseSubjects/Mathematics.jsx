...
function Mathematics() {
    ...
    return (
        ...
        <div className='courseSubjects-header' onFocus={ScrollToTop()} style={{margin:'0 auto', textAlign:'center', padding:'3rem  1.5rem', paddingBottom:'100%', width:'100%', background:'dodgerblue'}}>
            ...
            <div id='courseSubjects-hd' >
                <h1 style={{color:'black'}}>MATHEMATICS</h1> 
                <p style={{color:'white'}}>Here are lists of availaible topics in Mathematics. Click to learn more.</p>
                <br />
            </div>
